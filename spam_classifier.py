...
def tokenize(message):
    ...
    text_tokens = tokenizer.tokenize(message)
    stopWords = stopwords.words("english")
    setStopWords = set(stopWords)
    tokens_without_sw = [word + " " for word in text_tokens if not word in setStopWords and word != "com"]
...
def get_subject_data(path):
    ...
    subject_regex = re.compile(r"^From:\s+")
